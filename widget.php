...
class WPTimeTwitterProfileWidget extends WP_Widget {
	...
	function form( $instance ) {
		...
		?>
            ...
            <?php 
				$wpt_tp_buy_extension_wid = '<p>Recent tweets will be working after buying the extension, <a href="http://wp-plugins.in/buy_recent_tweets_extension" target="_blank">Buy Extension</a> for $3.99 only.</p>';
